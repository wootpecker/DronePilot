...
def main():
    ...
    plot_prediction1(model_type)
    #plot_predictions2(model_type)


def plot_prediction1(model_type):
    ...
    fig, axes = plt.subplots(1, 1, figsize=(5, 5),tight_layout=True) #tight_layout=True)
    X_img=X[0:21,0:21]

    # Image A
    #axes.set_title('Position A', fontsize=16)
    img1= axes.imshow(X_img, cmap="viridis", origin="lower",alpha=0.9)
    img1_flightpath = axes.scatter(flight_path[:,1],flight_path[:,0], color="yellow",alpha=0.7, s=10, label='Flight Path')
...
def plot_predictions2(model_type):
    ...
    img2_flightpath = axes[1].scatter(flight_path[:,1],flight_path[:,0], color="yellow",alpha=0.7, s=10, label='Flight Path')
...
def plot_predictions3():
    ...
    axes[0].set_title('Position A', fontsize=16)
    img1= axes[0].imshow(X_img, cmap="viridis", origin="lower",alpha=0.9)
    img1_flightpath = axes[0].scatter(flight_path[:,1],flight_path[:,0], color="yellow",alpha=0.7, s=10, label='Flight Path')
    ...
    img3_flightpath = axes[2].scatter(flight_path[:,1],flight_path[:,0], color="yellow",alpha=0.7, s=10, label='Flight Path')
